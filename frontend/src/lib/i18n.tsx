...
const EN: Record<string, string> = {
  ...
  'Chcę fakturę': 'I want an invoice',
  ...
  'Termin jest nadal dla Ciebie zarezerwowany — możesz spróbować zapłacić ponownie.':
    'The appointment is still reserved for you — you can try paying again.',
  ...
  'Przekaż kod lekarzowi lub pielęgniarce — po użyciu zachowuje stały wgląd w wybrany zakres (nie trzeba dawać kodu przy każdej wizycie). Dostęp odwołasz w każdej chwili poniżej.':
    'Give the code to a doctor or nurse — once used, they keep ongoing access to the chosen scope (no need to hand out a code at every visit). You can revoke access anytime below.',
  'do odebrania do:': 'claim by:',
  '(potem dostęp jest już stały)': '(access stays permanent afterwards)',
  'stały dostęp od': 'permanent access since',
  'czeka na odebranie do': 'awaiting pickup until',
  ...
  'Odepnij': 'Unlink',
  'Potwierdź': 'Confirm',
  'Profil i ustawienia': 'Profile & settings',
  'Konto': 'Account',
  'Do zrobienia': 'To do',
  'Potwierdź obecność': 'Confirm attendance',
  'Nowe wyniki badań': 'New test results',
  'Skierowanie do umówienia': 'Referral to book',
  'Oceń wizytę': 'Rate your visit',
  'Dane osobowe': 'Personal details',
  'Telefon': 'Phone',
  'E-mail': 'Email',
  'Zapisano': 'Saved',
  'Powiadomienia': 'Notifications',
  'eWUŚ: ubezpieczony': 'eWUŚ: insured',
  'eWUŚ: brak potwierdzenia': 'eWUŚ: not confirmed',
  'na ten numer pójdą SMS-y z przypomnieniami': 'reminders will be sent to this number',
  'Przypomnienia o wizytach i nowe dokumenty SMS-em. Powiadomienia w aplikacji są zawsze aktywne.':
    'Visit reminders and new documents by SMS. In-app notifications are always on.',
  'Hasło i bezpieczeństwo': 'Password & security',
  'Hasło zmienisz przez „Nie pamiętam hasła” na ekranie logowania — wyślemy link na Twój adres e-mail.':
    'Change your password via “Forgot password” on the login screen — we’ll email you a link.',
  'Nie udało się zapisać danych.': 'Could not save your details.',
