"""schemat poczatkowy z ERD

Revision ID: 49b247296e47
Revises: 
Create Date: 2026-06-10 03:26:20.584511
...
def upgrade() -> None:
    ...
    sa.Column('staff_clinic_id', sa.Integer(), nullable=False),
    sa.Column('clinic_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    sa.Column('patient_clinic_id', sa.Integer(), nullable=False),
    sa.Column('clinic_id', sa.Integer(), nullable=False),
    sa.Column('patient_id', sa.Integer(), nullable=False),
    ...
    sa.Column('sick_leave_id', sa.Integer(), nullable=False),
    sa.Column('document_id', sa.Integer(), nullable=False),
