...
app.add_middleware(
    ...
    # luźny regex dopuszczający adresy LAN (testy z innych urządzeń) — TYLKO w dev;
    # w produkcji obowiązuje sama whitelista cors_origins (konkretne domeny)
    allow_origin_regex=settings.cors_origin_regex if settings.dev_mode else None,
